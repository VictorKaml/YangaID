...
public class progressBarNational extends AppCompatActivity {
    int progress = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_progress_bar_national);
                ...
                while (progress < 100){
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (progress == 100) {
                                startActivity(new Intent(progressBarNational.this, ViewNationalID.class));
                            }
                            if (progress > 70) {
