...
public class ViewShareMedical extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ViewShareMedical.this, Home.class));
            }
        });
        ...
        String StudentsUid = intent.getStringExtra("MedicalUid");
