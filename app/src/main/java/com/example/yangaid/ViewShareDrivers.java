...
public class ViewShareDrivers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_share_drivers);

        backButton = (ImageButton) findViewById(R.id.back);
        backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ViewShareDrivers.this, Home.class));
            }
        });
        ...
        reference.child(DriversUid).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
